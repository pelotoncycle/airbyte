...
import pytest
from source_affirm.source import AffirmStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(AffirmStream, "path", "v0/example_endpoint")
    mocker.patch.object(AffirmStream, "primary_key", "test_primary_key")
    mocker.patch.object(AffirmStream, "__abstractmethods__", set())
