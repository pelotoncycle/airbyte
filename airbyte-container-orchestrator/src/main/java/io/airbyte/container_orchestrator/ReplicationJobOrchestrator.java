...
public class ReplicationJobOrchestrator implements JobOrchestrator<StandardSyncInput> {
  ...
  public Optional<String> runJob() throws Exception {
    ...
    final ResourceRequirements sourceRequirements = ResourceRequirementsUtils.getResourceRequirements(syncInput.getSourceResourceRequirements(), defaultRequirements);
    ...
    final ResourceRequirements destRequirements = ResourceRequirementsUtils.getResourceRequirements(syncInput.getDestinationResourceRequirements(),defaultRequirements);
